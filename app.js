...
(function initSpeechBubble() {
    ...
    ready(function () {
        ...
        var textEl = document.getElementById('speechText');
        var iconEl = document.getElementById('cubeIcon');

        if (!bubble || !textEl || !iconEl) return;
        ...
        function scheduleRandom() {
            var delay = Math.random() * 10000 + 12000;
            setTimeout(function () {
